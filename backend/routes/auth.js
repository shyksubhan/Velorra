...
router.post('/register', async (req, res) => {
  try {
    ...
    return res.status(201).json({ message: 'Account created! Welcome to Velorra Jewelry 💧', token, user: { id: uid, fname: userData.fname, lname: userData.lname, email: normalEmail, phone: userData.phone } });
